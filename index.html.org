           ...
           <div class="row">
              <div class="col-lg-6 col-md-5 col-12">
                <div class="contact-image" data-aos="fade-up">
                      <img src="images/logo.jpg" class="img-fluid" alt="website">
                </div>
              </div>
              <div class="col-lg-6 col-md-7 col-12">
                ...
                <br/><br/><br/>
					      <div class="contact-image" data-aos="fade-up">
                    <img src="images/loding1.png" class="img-fluid" alt="website">
                    <a name="info"></a>
                              </div>
                    <h2 class="mb-4" data-aos="fade-up" data-aos-delay="300">گروه دوستان خاص کار خود را از اسفند ماه 1398 آغاز کرد و در خرداد ماه سال 99 اولین بازی رسمی خود را با نام "کووید 19" منتشر کرد. 
                    دوستان خاص متشکل از یک تیم 4 نفره (علی امامی، مهدی برادر یاوری، کمیل پارسه، محمد امین دژبان) است که در حوزه های برنامه نویسی، بازی سازی، تولید محتوا و ... فعالیت می کند</h2>

                    <p data-aos="fade-up" data-aos-delay="400">
                      <!--<strong>گروه دوستان خاص</strong>-->
